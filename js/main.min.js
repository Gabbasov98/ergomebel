function setLabelPlace(){document.querySelectorAll(".fg input,.fg textarea,.fg-dynamic select").forEach(t=>{function a(){""!==t.value?t.classList.add("_filled"):t.classList.remove("_filled")}a(),t.onchange=()=>{a()}})}$("._tab").click((function(){let t=$(this).parents("._tabs-parent"),a=$(this).attr("data-tab");$(t).find("._tab").removeClass("_active"),$(this).addClass("_active"),$(t).find(".tab-content").removeClass("_active"),$(t).find("."+a).addClass("_active")})),$(".mob-delivery-tab").click((function(){$(this).toggleClass("_active"),$(this).siblings(".mob-delivery-tab__content").slideToggle()})),$(".favourite-btn,.compare-btn,.cart-btn").click((function(){$(this).toggleClass("_added")})),$(document).on("click",".rating-input__item",(function(t){let a=parseInt($(this).attr("data-rating-value"));$(this).parent(".rating-input").attr("data-total-rating",a),$(this).siblings(".rating-input__field").val(a)})),setLabelPlace(),$(".qa-card").click((function(){$(this).toggleClass("_active"),$(this).find(".qa-card__hidden").slideToggle()})),$(".cartcalc").each((function(t,a){let i=$(a).find(".ccalc-plus"),e=$(a).find(".ccalc-minus"),l=$(a).find("input");function n(){1===+$(l).val()?$(e).addClass("_disabled"):$(e).removeClass("_disabled")}$(e).click((function(t){let a=$(l).val();if(a>1){let t=+a-1;$(l).val(t),$(l).trigger("change")}else $(l).val(a);n(),t.stopImmediatePropagation()})),$(i).click((function(t){let a=+$(l).val()+1;$(l).val(a),$(l).trigger("change"),n(),t.stopImmediatePropagation()})),n()}));
$("._toggle-menu").click((function(){$(".header").toggleClass("_open"),$("body").toggleClass("fixed-body")})),$(".nav2 .menu>li>a").click((function(){let e=$(this).find(".menu__icon img").attr("src"),s=$(this).find(".menu__title").html();$(".sub-menu-top__icon img").attr("src",e),$(".sub-menu-top__title").html(s),$(this).parents("li").hasClass("_open")?($(".nav2 .menu>li").removeClass("_open"),$(".header").removeClass("_open-sub-menu")):($(".nav2 .menu>li").removeClass("_open"),$(".header").removeClass("_open-sub-menu"),$(this).parents("li").addClass("_open"),$(".header").addClass("_open-sub-menu"))})),$(document).mouseup((function(e){let s=$(".nav2");s.is(e.target)||0!==s.has(e.target).length||$(s).find("li").hasClass("_open")&&$(s).find("li").removeClass("_open")})),$("._close-sub-menu").click((function(){$(".nav2 .menu>li").removeClass("_open"),$(".header").removeClass("_open-sub-menu")})),$(".header-city__show").click((function(){$(".header-city").toggleClass("_open")})),$(".slider").click((function(){$(".header-city").removeClass("_open")})),$("._close-search-modal").click((function(){$(".header-city").removeClass("_show-modal")})),$(document).mouseup((function(e){let s=$(".header-city");s.is(e.target)||0!==s.has(e.target).length||$(s).hasClass("_open")&&$(s).removeClass("_open")})),$("._search-field").on("input",(function(){$(this).val().length>0?$(".header-search").addClass("_show-result"):$(".header-search").removeClass("_show-result")})),$(".header-search__clear").click((function(){$("._search-field").val("").trigger("input"),$("._search-field").val("").trigger("change")}));
...
$(".m-dropdown__show").click((function(){$(this).parents(".m-dropdown").hasClass("_open")?$(".m-dropdown").removeClass("_open"):($(".m-dropdown").removeClass("_open"),$(this).parents(".m-dropdown").addClass("_open"))})),$(".m-dropdown__options input").change((function(){let e=$(this).attr("data-value");$(this).parents(".m-dropdown").find(".m-dropdown__current").html(e),$(this).parents(".m-dropdown").addClass("_selected"),$(this).parents(".m-dropdown").removeClass("_open")})),$(document).mouseup((function(e){let o=$(".m-dropdown");o.is(e.target)||0!==o.has(e.target).length||$(o).hasClass("_open")&&$(o).removeClass("_open")})),$(".filter .filter-item").each((function(e,o){let n=$(o).find(".m-dropdown__show"),t=$(o).find("input");$(n).click((function(){$(o).hasClass("_open")?$(".m-dropdown").removeClass("_open"):($(".m-dropdown").removeClass("_open"),$(o).addClass("_open"))})),$(t).change((function(){0!==$(o).find(".m-check input:checked").length?($(o).addClass("_selected"),$(".filter__all input").prop("checked",!1)):$(o).removeClass("_selected")})),$(".m-dropdown__clear").click((function(){$(t).each((function(e,o){$(o).prop("checked",!1)})),$(o).removeClass("_selected")}))})),$(".filter__all input").change((function(){$(this).prop("checked")&&$(".filter .m-dropdown__options input").each((function(e,o){$(o).prop("checked",!1),$(o).trigger("change")}))})),$(".filter2-group__top").click((function(){$(this).parents(".filter2-group").toggleClass("_active"),$(this).siblings(".filter2-group__bottom").slideToggle()})),$(".filter2-group__more").click((function(){$(this).parents(".filter2-group").toggleClass("_show-all-checks")}));
...
let maps=document.querySelectorAll("[data-cord1]");ymaps.ready(init);let coord=[];function init(){maps.forEach(a=>{!function(a){let e=[+a.dataset.cord1,+a.dataset.cord2],o=new ymaps.Map(a,{center:e,zoom:18,controls:[]});o.controls.add("zoomControl"),o.behaviors.disable("scrollZoom");let t=new ymaps.Placemark(e,{},{iconLayout:"default#image",iconImageHref:"img/mark.svg",iconImageSize:[48,60],iconImageOffset:[-24,-30]});o.geoObjects.add(t),t.events.add(["click"],a=>{let e=$(".map-modal._active");e&&$(e).find(".contacts-info").toggleClass("_active")})}(a)})}
...
$(".cart-colors__show").click((function(){$(this).parents(".cart-colors").toggleClass("_active"),$(this).siblings(".cart-colors__hidden").slideToggle()})),$(".cart-card__mob-nav-btn").click((function(){$(this).parents(".cart-card").toggleClass("_active"),$(this).parents(".cart-card").find(".cart-card__mob-hide").slideToggle()})),$("._toggle-order-modal").click((function(){$(".order-modal").toggleClass("_open"),$("body").toggleClass("fixed-body")})),$(".cart-map__search input").on("input",(function(){$(this).val().length>3&&$(this).parents(".cart-map__search").addClass("_show")})),$(document).mouseup((function(e){let a=$(".cart-map__search");a.is(e.target)||0!==a.has(e.target).length||$(a).hasClass("_show")&&$(a).removeClass("_show")})),$('[name="reqType"]').change((function(){let e=$(this).attr("data-value");$(".order-requisites__view").removeClass("_active"),$(".order-requisites__view."+e).addClass("_active")})),$('[name="deliveryTariff"],[name="deliveryTarget"]').change((function(){let e=$(this).attr("data-value");$(this).parents(".delivery-type").find(".delivery-tariff__view").removeClass("_active"),$(this).parents(".delivery-type").find(".delivery-tariff__view."+e).addClass("_active")})),$('[name="deliveryType"]').change((function(){let e=$(this).attr("data-value");$(".delivery-type").removeClass("_active"),$(".delivery-type."+e).addClass("_active")})),$('[name="userType"]').change((function(){let e=$(this).attr("data-value");$("._user-type-fields").removeClass("_active"),$("._user-type-fields."+e).addClass("_active")}));
...
function isInViewport(t){const e=t.getBoundingClientRect();return e.top>=0&&e.left>=0&&e.bottom<=(window.innerHeight||document.documentElement.clientHeight)&&e.right<=(window.innerWidth||document.documentElement.clientWidth)}const numbers=document.querySelectorAll(".js-animate-number");numbers.forEach(t=>{let e=t.textContent;t.setAttribute("num",e),t.textContent="0";const n=+t.getAttribute("data-speed");["scroll","DOMContentLoaded"].forEach(e=>document.addEventListener(e,(function(){if(1==isInViewport(t)){const e=()=>{const o=+t.getAttribute("num"),i=+t.innerText,r=o/n;i<o?(t.innerText=Math.ceil(i+r).toLocaleString(),setTimeout(e,1)):t.innerText=o.toLocaleString()};e()}}),{passive:!0}))});
var BACKSPACE_KEY=8,ENTER_KEY=13,TAB_KEY=9,LEFT_KEY=37,RIGHT_KEY=39,ZERO_KEY=48,NINE_KEY=57;function otp(t){var e=document.querySelectorAll(".js-otp-input"),n=null;function u(t,u){u.addEventListener("input",(function(u){!function(t,u){var l=u.data||u.target.value,f=t;for(i=0;i<l.length;i++)if(i<e.length){if(!o(l[i])){e[f].value="";break}e[f++].value=l[i],f==e.length?r()&&n(a()):e[f].focus()}}(t,u)})),u.addEventListener("paste",(function(u){!function(t,u){u.preventDefault();var r=t,l=(u.clipboardData||window.clipboardData).getData("Text");for(i=0;i<l.length;i++)if(i<e.length){if(!o(l[i]))break;e[r].value=l[i],r++}r==e.length?(e[r-1].focus(),n(a())):e[r].focus()}(t,u)})),u.addEventListener("keydown",(function(i){!function(t,i){var u=i.keyCode||i.which;u==LEFT_KEY&&t>0&&(i.preventDefault(),e[t-1].focus());u==RIGHT_KEY&&t+1<e.length&&(i.preventDefault(),e[t+1].focus());u==BACKSPACE_KEY&&t>0&&(""==e[t].value?(e[t-1].value="",e[t-1].focus()):e[t].value="");u==ENTER_KEY&&(i.preventDefault(),r()&&n(a()));u==TAB_KEY&&t==e.length-1&&(i.preventDefault(),r()&&n(a()))}(t,i)}))}function a(){var t="";for(i=0;i<e.length;i++)t+=e[i].value;return t}function o(t){return t>="0"&&t<="9"}function r(){for(var t=!0,n=0;n<e.length&&t;)""==e[n].value&&(t=!1),n++;return t}return{init:function(t){for(n=t,i=0;i<e.length;i++)u(i,e[i])}}}var otpModule=otp("otp-inputs");otpModule.init((function(t){}));
function fix100vh(){let e=.01*window.innerHeight;document.documentElement.style.setProperty("--vh",e+"px")}window.addEventListener("DOMContentLoaded",()=>{fix100vh(),window.addEventListener("resize",()=>{fix100vh(),getScrollBarSize()}),getScrollBarSize(),$('input[type="tel"]').mask("+7 (999) 999-99-99",{autoclear:!1},{placeholder:"+7 (   )    -  -  "})}),$(".catalog-btn").click((function(){$(".header-city").removeClass("_show-modal"),$(".catalog-modal").toggleClass("_active"),$(".header").toggleClass("_show-catalog")})),$(".catalog-modal .close-btn").click((function(){$(".catalog-modal").removeClass("_active"),$(".header").removeClass("_show-catalog")})),$(document).mouseup((function(e){let a=$(".catalog-modal");a.is(e.target)||0!==a.has(e.target).length||$(a).hasClass("_active")&&($(a).removeClass("_active"),$(".header").removeClass("_show-catalog"))}));
