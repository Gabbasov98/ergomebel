...
$("._toggle-menu").click((function(){$(".header").toggleClass("_open"),$("body").toggleClass("fixed-body")})),$(".nav2 .menu>li>a").click((function(){let e=$(this).find(".menu__icon img").attr("src"),s=$(this).find(".menu__title").html();$(".sub-menu-top__icon img").attr("src",e),$(".sub-menu-top__title").html(s),$(this).parents("li").addClass("_open"),$(".header").addClass("_open-sub-menu")})),$("._close-sub-menu").click((function(){$(".nav2 .menu>li").removeClass("_open"),$(".header").removeClass("_open-sub-menu")})),$(".header-city__show").click((function(){$(".header-city").toggleClass("_open")})),$(".slider").click((function(){$(".header-city").removeClass("_open")})),$("._close-search-modal").click((function(){$(".header-city").removeClass("_show-modal")})),$(document).mouseup((function(e){let s=$(".header-city");s.is(e.target)||0!==s.has(e.target).length||$(s).hasClass("_open")&&$(s).removeClass("_open")})),$("._search-field").on("input",(function(){$(this).val().length>0?$(".header-search").addClass("_show-result"):$(".header-search").removeClass("_show-result")})),$(".header-search__clear").click((function(){$("._search-field").val("").trigger("input"),$("._search-field").val("").trigger("change")}));
